  ...
  return (
    <div className="page-wrapper" style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ textAlign: 'left', padding: '0 20px 0', position: 'relative', width: '100%', flexShrink: 0 }}>
        ...
        <div style={{ position: 'relative', display: 'inline-block', flexShrink: 0, marginTop: '-20px', marginLeft: '-15px', marginBottom: '-10px' }}>
      ...
      <main style={{ flex: 1, padding: '0 20px 40px', maxWidth: 1000, margin: '0 auto 0', width: '100%', position: 'relative', zIndex: 10 }}>
        ...
        {/* Swapping Container */}
        <div style={{ position: 'relative', width: '100%', height: 360, transition: 'height 0.5s' }}>
          ...
          <div style={{
            ...
            <div className="folder-tabs-container" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
              ...
              {/* Panel Content */}
              <div className="folder-content" style={{ justifyContent: 'space-evenly', flex: 1, minHeight: 0, overflowY: 'auto', padding: activeTab === 'createRoom' ? '4px 12px' : '12px 30px', gap: activeTab === 'createRoom' ? 0 : undefined }}>

                {activeTab === 'anonymous' ? (
                  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', flex: 1, gap: 14, padding: '5px 0' }}>
                    ...
                    <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                        <div style={{ position: 'relative' }}>
                          <img src={avatarUrl(avatarSeed)} alt="Your avatar"
                            style={{ width: 130, height: 130, borderRadius: '50%', border: '4px solid #000000', boxShadow: 'inset 0 0 0 2px #ffffff, 4px 4px 0px #000000', background: 'var(--secondary-container)' }}
                          />
                          <button
                      ...
                      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <div>
                          <p style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 12, marginBottom: 6, color: '#000000', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'flex', alignItems: 'center', gap: 4 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4 }}>
                          ...
                          />
                          <label htmlFor="spectator-join" style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 12, color: '#000000', cursor: 'pointer', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                            Join as Spectator
                          </label>
                        </div>
                      </div>
                    ...
                    {/* Join Button (Bottom) */}
                    <button className="btn" style={{ width: '100%', fontSize: 16, padding: '12px 0', marginTop: 12, borderRadius: 8, background: '#a78bfa', color: '#000000', border: '4px solid #000000', boxShadow: 'inset 0 0 0 2px #ffffff, 4px 4px 0px #000000', fontWeight: 900, transition: 'all 0.1s' }}
                      onClick={handleJoin} disabled={loading === 'join'}
                      onMouseDown={pressDown} onMouseUp={pressUp} onMouseLeave={pressUp}
                    >
                      <span className="material-symbols-outlined" style={{ fontSize: 22, marginRight: 8, marginBottom: -9, verticalAlign: 'middle' }}>login</span>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6, padding: '2px 0' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px 12px', marginTop: 2 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
                        ...
                        <select value={maxPlayers} onChange={e => setMaxPlayers(+e.target.value)} style={{ ...neoSelectCompact, width: '70px', padding: '2px 4px', fontSize: 11, border: '2px solid #000', boxShadow: '1.5px 1.5px 0px #000' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
                        ...
                        <select value={language} onChange={e => setLanguage(e.target.value)} style={{ ...neoSelectCompact, width: '70px', padding: '2px 4px', fontSize: 11, border: '2px solid #000', boxShadow: '1.5px 1.5px 0px #000' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
                        ...
                        <select value={drawTime} onChange={e => setDrawTime(+e.target.value)} style={{ ...neoSelectCompact, width: '70px', padding: '2px 4px', fontSize: 11, border: '2px solid #000', boxShadow: '1.5px 1.5px 0px #000' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
                        ...
                        <select value={rounds} onChange={e => setRounds(+e.target.value)} style={{ ...neoSelectCompact, width: '70px', padding: '2px 4px', fontSize: 11, border: '2px solid #000', boxShadow: '1.5px 1.5px 0px #000' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
                        ...
                        <select value={wordCount} onChange={e => setWordCount(+e.target.value)} style={{ ...neoSelectCompact, width: '70px', padding: '2px 4px', fontSize: 11, border: '2px solid #000', boxShadow: '1.5px 1.5px 0px #000' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 6 }}>
                        ...
                        <select value={hints} onChange={e => setHints(+e.target.value)} style={{ ...neoSelectCompact, width: '70px', padding: '2px 4px', fontSize: 11, border: '2px solid #000', boxShadow: '1.5px 1.5px 0px #000' }}>
          ...
          <div style={{
            ...
            <div
              ...
              style={{ flex: 1, marginTop: 46, padding: '10px 14px' }}
              onMouseEnter={() => setIsHoveringHelp(true)}
              onMouseLeave={() => setIsHoveringHelp(false)}
            >
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 900, color: '#000000', textAlign: 'center', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                How To Play
              </h2>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                  ...
                  <div key={iconAnimKey} className="icon-emblem step-change" style={{ width: 48, height: 48, borderWidth: 3, marginBottom: 6, boxShadow: '3px 3px 0px #000' }}>
                    <span className="material-symbols-outlined help-icon" style={{ fontSize: 24 }}>
                      {howToPlaySteps[howToPlayStep].icon}
                    </span>
                  </div>
                  <h3 key={`title-${iconAnimKey}`} className="step-text-animate"
                    style={{ fontFamily: 'var(--font-display)', fontSize: 13, fontWeight: 900, marginBottom: 2, color: '#000000' }}>
                    {howToPlaySteps[howToPlayStep].title}
                  </h3>
                  <p key={`desc-${iconAnimKey}`} className="step-text-animate"
                    style={{ color: '#555555', fontSize: 11, fontWeight: 600, maxWidth: 230, margin: '0 auto', lineHeight: 1.3 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 6 }}>
                <button className="carousel-btn" onClick={handlePrevStep} style={{ width: 28, height: 28, padding: 0, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span className="material-symbols-outlined" style={{ fontSize: 16, color: '#000000' }}>navigate_before</span>
                </button>
                ...
                <button className="carousel-btn" onClick={handleNextStep} style={{ width: 28, height: 28, padding: 0, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span className="material-symbols-outlined" style={{ fontSize: 16, color: '#000000' }}>navigate_next</span>
                </button>
              </div>

              {/* Auto-play hint */}
              <p style={{ textAlign: 'center', fontSize: 9, fontFamily: 'var(--font-mono)', color: '#aaaaaa', marginTop: 2, letterSpacing: '0.05em' }}>
            ...
            <div style={{
              ...
              <img src={doodlzCharacters} alt="Doodlz characters" style={{ width: 44, height: 44, objectFit: 'contain', flexShrink: 0 }} />
              <div>
                <p style={{ fontFamily: 'var(--font-mono)', fontSize: 11, fontWeight: 700, color: '#333333', lineHeight: 1.3, fontStyle: 'italic' }}>
                  "Creativity is the enemy of boredom. Let's make something weird today... because Picasso had to start somewhere too."
                </p>
              </div>
              {/* Speech bubble tail */}
              <div style={{
                position: 'absolute', top: -11, left: 30,
                width: 0, height: 0,
                borderLeft: '8px solid transparent',
                borderRight: '8px solid transparent',
                borderBottom: '11px solid #000000',
              }} />
              <div style={{
