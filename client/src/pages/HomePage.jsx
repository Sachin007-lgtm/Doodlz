          ...
          <div style={{ 
            ...
            display: 'flex', flexDirection: 'column', gap: 16
             ...
             <div style={{
               ...
               borderRadius: 4,
               boxShadow: 'inset 0 0 0 2px #ffffff, 5px 5px 0px #000000',
               padding: '12px 16px',
               display: 'flex',
               alignItems: 'center',
               gap: 12,
               ...
               <div>
                 <p style={{ fontFamily: 'var(--font-mono)', fontSize: 12, fontWeight: 700, color: '#333333', lineHeight: 1.4, fontStyle: 'italic' }}>
